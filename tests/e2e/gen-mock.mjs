 ...
 * e2e-mock.cjs. The two scansion entries are copied VERBATIM from the
 * transport test (tests/unit/syllable-overrides.test.js): they are canonical
 * solver shapes exercised through the transport
 * (core/syllable-overrides.js) and the quantity validator
 * (core/latin-quantity.js) by the unit suite. Also generates
 * mock-elision.json, an Aeneid 1.3 double-elision fixture.
 *
...
console.log("wrote", elisionTarget, "(Aen. 1.3 double-elision fixture)");
