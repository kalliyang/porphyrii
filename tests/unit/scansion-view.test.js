...
test("confidenceNotice: low must warn, medium may warn, high silent", () => {
...
test("view model: elided syllables render with parentheses", () => {
  const contract = {
    ...HEX_CONTRACT,
    scansion: [
      {
...
test("view model: prose degrades to the macronized text, no feet (the analysis-response contract)", () => {
  const contract = {
    ...HEX_CONTRACT,
    meter: "prose",
    scansion: [
...
// ---------------------------------------------------------------------------
// validatorNotices (quantity-validator presentation)
// ---------------------------------------------------------------------------
