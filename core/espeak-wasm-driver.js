/**
 * core/espeak-wasm-driver.js — recitation driver seam.
 *
 * Thin adapter between app/audio.js and the vendored espeak-ng-wasm v0.1.1
 * driver in vendor/espeak-ng/.
 ...
 * "loading" state covers the actual engine download and compilation.
 *
 ...
 * so the wasm/data fetch and compile overlap with it. A failed
...
async function artifactURL(name) {
  ...
  // plain filesystem paths, not file: URLs.
